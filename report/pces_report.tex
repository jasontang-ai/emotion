...
\vspace{0.45in}
\begin{center}
{\LARGE\bfseries Same Scenario, Different Subject\footnotemark[1] \par}
\vspace{0.15in}
{\large\bfseries A Perspective-Controlled Emotion Benchmark and a Pre-Registered Behavioral Battery for Model Welfare Research \par}
\end{center}
\vspace{0.3in}
\hrule height 0.6pt
\vspace{0.5in}
...
\subsectiongray{The validation step caught a real confound}
